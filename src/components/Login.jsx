        ...
        <form className="flex flex-col gap-2" action="">
          ...
          <div className="flex gap-3">
            <button
              ...
              type="submit"
              className="flex w-1/2 justify-center rounded bg-blue-600 py-[1px] text-center text-base text-white transition duration-200 hover:bg-blue-900 "
            >
              Log In
            </button>
            <button
              type="button"
              className="flex w-1/2 justify-center rounded border bg-white py-[1px] text-center text-slate-600 transition duration-200 hover:bg-gray-500 hover:text-white "
            >
              Create Account
            </button>
          </div>
